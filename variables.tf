...
variable "users" {
  ...
  description = "A map containing the usernames of each PCA user and a list of roles assigned to that user.  The only currently-defined role is \"provisioner\".  Example: { \"firstname1.lastname1\" = { \"roles\" = [ \"provisioner\" ] } }"
}
